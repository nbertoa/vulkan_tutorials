...
public:
    ...
    //
    //   - flags bitmask specifying additional properties of the attachment:
    ...
    //   - samples count of the image as defined in VkSampleCountFlagBits.
    //   - loadOp specifying how the contents of color and depth components of the attachment 
    //     are treated at the beginning of the subpass where it is first used.
    //   - stencilLoadOp specifying how the contents of stencil components of the attachment 
    //     are treated at the beginning of the subpass where it is first used:
    //
    ...
    //       For attachments with a color format, this uses the access type VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT.
    //
    //   - storeOp specifying how the contents of color and 
    //     depth components of the attachment are treated at the end of the subpass where it is last used.
    //   - stencilStoreOp specifying how the contents of stencil 
    ...
    //
    //   - flags bitmask specifying usage of the subpass.
    ...
    //   - pInputAttachments array defining the input attachments for this subpassand their layouts:
    //   - pColorAttachments array defining the color attachments for this subpassand their layouts:
    //   - pResolveAttachments array defining the resolve attachments for this subpassand their layouts:
    //   - pDepthStencilAttachment array specifying the depth / stencil attachment for this subpassand its layout:
    //
    ...
    //
    //   - preserveAttachmentCount of pPreserveAttachments
    //   - pPreserveAttachments array of render pass 
    ...
    //
    //   - srcSubpass index of the first subpass in the dependency, or VK_SUBPASS_EXTERNAL.
    //   - dstSubpass index of the second subpass in the dependency, or VK_SUBPASS_EXTERNAL.
    //   - srcStageMask bitmask specifying the source stage mask:
    //   - dstStageMask bitmask specifying the destination stage mask:
    ...
    //
    //   - dependencyFlags bitmask of VkDependencyFlagBits:
    //
